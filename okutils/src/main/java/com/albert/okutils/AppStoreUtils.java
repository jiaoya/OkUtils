 ...
 *      Author       : jiaoya.
 *      Created Time : 2021/1/27.
 *      Desc         : 跳转到自己 应用 对应手机厂商的应用商店的主页
 * </pre>
 */
public class AppStoreUtils {

    private static AppStoreUtils tools;
    private static final String schemaUrl = "market://details?id=";

    public static AppStoreUtils getTools() {
        if (null == tools) {
            tools = new AppStoreUtils();
        }
        return tools;
    }
    ...
    public boolean startMarket(Context mContext, String packageName) {
        ...
        if (null == marketPackageName || "".equals(marketPackageName)) {
            ...
            if (isExit1) {
                return startMarket(mContext, packageName, PACKAGE_NAME.BAIDU_PACKAGE_NAME);
            }
            boolean isExit2 = isCheckBaiduOrYYB(mContext, PACKAGE_NAME.TENCENT_PACKAGE_NAME);
            if (isExit2) {
                return startMarket(mContext, packageName, PACKAGE_NAME.TENCENT_PACKAGE_NAME);
            }
        }
    ...
    public boolean startMarket(Context mContext, String packageName, String marketPackageName) {
        if (!NullUtil.notEmpty(marketPackageName)) {
            return false;
        }
        try {
    ...
    private String getBrandName(String brandName) {
        if (BRAND.HUAWEI_BRAND.equals(brandName)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                return PACKAGE_NAME.OPPO_PACKAGE_NAME_Q;
            } else {
    ...
    public static class BRAND {
        ...
        public static final String REDMI_BRAND = "REDMI";// 红米
    ...
    public static class PACKAGE_NAME {
        ...
        public static final String OPPO_PACKAGE_NAME_Q = "com.heytap.market";//oppo
