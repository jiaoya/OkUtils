 ...
 *     time  : 2021/11/30
 *     desc  : 状态栏 actionbar  NavigationBar
 * </pre>
 */
public final class BarUtils {
    ...
    // 新版写法
    ///////////////////////////////////////////////////////////////////////////////////////////
    private static void setStatusBarVisibility1(@NonNull final Window window,
                                               final boolean isVisible) {
     ...
     * @param window
     */
    private static void setStatusBarVisible(@NonNull final Window window) {
        try {
            WindowInsetsController windowInsetsController = window.getDecorView().getWindowInsetsController();
     ...
     * @param window
     */
    private static void setStatusBarGone(@NonNull final Window window) {
...
//        WindowInsetsController windowInsetsController = window.getDecorView().getWindowInsetsController();
//        //windowInsetsController.setSystemBarsAppearance(WindowInsetsController.APPEARANCE_OPAQUE_STATUS_BARS,WindowInsetsController.APPEARANCE_OPAQUE_STATUS_BARS);
